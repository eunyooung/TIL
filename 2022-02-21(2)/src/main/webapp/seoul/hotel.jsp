              ...
              <c:forEach var="vo" items="${list }" varStatus="s">
                <c:choose>
                  <c:when test="${s.index%4==0}">
                    <li class="one_quarter first"><a href="../seoul/hotel_detail.do?no=${vo.no }"><img src="${vo.poster }" title="${vo.name }" style="width:320px;height: 185px"></a></li>
                  </c:when>
                  <c:otherwise>
                    <li class="one_quarter"><a href="../seoul/hotel_detail.do?no=${vo.no }"><img src="${vo.poster }" title="${vo.name }" style="width:320px;height: 185px"></a></li>
                  </c:otherwise>
                </c:choose>
              </c:forEach>
            </ul>
