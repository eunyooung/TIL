      ...
      <table class="table">
        <tr rowspan="2" height="500">
          <td class="text-center" width=20% valign="top">
            <table class="table">
              <tr>
                <td><div id="food_house" style="height: 500px;overflow-y:scroll "></div></td>
              </tr>
            </table>
          </td>
          ...
          <td class="text-center" width=35% valign="top">
            ...
            <table class="table">
              <tr>
                <td class="text-center"><img src="" width=150 height=150 id="reserve_poster"></td>
              </tr>
              <tr>
                <td>맛집명:<span id="reserve_name"></span>
