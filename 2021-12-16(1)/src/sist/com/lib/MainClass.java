...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("===== parse 결과값 =====");

        // 문자열 => 정수형으로 변환 
        int i1 = Integer.parseInt(num1);
        int i2 = Integer.parseInt(num2);
        System.out.println("Integer.parseInt i1+i2: " + (i1 + i2));

        // 문자열 => 실수형 변환
        double d1 = Double.parseDouble(num1);
        double d2 = Double.parseDouble(num2);
        System.out.println("Double.parseDouble d1+d2: " + (d1 + d2));

        // 문자열 => 논리형 변환
        boolean b1 = Boolean.parseBoolean(num1);
        boolean b2 = Boolean.parseBoolean(num2);
        System.out.println("Boolean.parseBoolean b1: " + b1);
        System.out.println("Boolean.parseBoolean b2: " + b2);
    }
}
