...
<head>
  ...
  <!-- <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/socketjs-client/1.3.0/socketjs.min.js"></script> -->
  ...
  <div class="container">
    ...
    <div class="row">
      <table class="table">
        <tr>
          <td>
            이름:<input type=text id=name class="inpu-sm">
