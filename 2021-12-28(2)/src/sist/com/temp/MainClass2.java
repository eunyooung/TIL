...
public class MainClass2 extends JFrame {
    ...
    public MainClass2() {
        la = new JLabel("로또 생성", JLabel.CENTER);
        la.setFont(new Font("궁서체", Font.BOLD, 35));
        add("North", la);
        JPanel p = new JPanel();
        tf1 = new JTextField("1   ", JLabel.CENTER);
        //tf1.setFont(new Font("궁서체",Font.BOLD,35));

        tf2 = new JTextField("2   ", JLabel.CENTER);
        //tf2.setFont(new Font("궁서체",Font.BOLD,35));

        tf3 = new JTextField("3   ", JLabel.CENTER);
        //tf3.setFont(new Font("궁서체",Font.BOLD,35));

        tf4 = new JTextField("4   ", JLabel.CENTER);
        //tf4.setFont(new Font("궁서체",Font.BOLD,35));

        tf5 = new JTextField("5   ", JLabel.CENTER);
        //tf5.setFont(new Font("궁서체",Font.BOLD,35));

        tf6 = new JTextField("6   ", JLabel.CENTER);
        //tf6.setFont(new Font("궁서체",Font.BOLD,35));
