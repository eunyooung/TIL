...
<body>
  <div class="container">
    <div class="row row_find">
      <table class="table">
        <tr>
          <td class="text-center"><input type=text size=50
            class="input-sm"> <input type=button value="검색"
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="thumbnail">
          <a href="#"> <img src="<%=vo.getPoster()%>" alt="Lights"
            style="width: 100%">
            <div class="caption">
              <p><%=vo.getTitle()%></p>
            </div>
    ...
    <div class="row">
      ...
      %>
              <div class="col-md-4">
                <div class="thumbnail">
                  <a href="#"> <img src="<%=vo.getPoster()%>" alt="Lights" style="width: 100%">
                    <div class="caption">
                      <p><%=vo.getTitle()%></p>
                    </div>
                  </a>
