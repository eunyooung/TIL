...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        for (EmpVO vo : list) {
            System.out.println(vo.getEmpno() + " " + vo.getEname() + " " + vo.getJob() + " " + vo.getHiredate().toString() + " " + vo.getSal() + " " + vo.getDeptno());
        }
        ...
        for (EmpVO jvo : jList) {
            System.out.println(jvo.getEmpno() + " " + jvo.getEname() + " " + jvo.getJob() + " "
                    + jvo.getHiredate().toString() + " " + jvo.getSal() + " " + jvo.getDeptno() + " "
                    + jvo.getDvo().getDname() + " " + jvo.getDvo().getLoc());
