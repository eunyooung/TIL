...
*/
-- 비교연산자 (입사일)
-- emp(사원정보) 사원중에 입사일이 1982년 이전에 입사한 사원의 모든 정보 
SELECT *
FROM emp
WHERE hiredate < '82/01/01'; 
-- emp(사원정보) 사원중에 입사일이 1981/01/01년 이후에 입사한 사원의 모든 정보
SELECT *
FROM emp
WHERE hiredate > '81/01/01';

-- 입사일중에 81/09/08에 입사한 사원의 이름,직위,입사일 ,급여 
-- 'YY/MM/DD' , 반드시 ''을 사용한다 (날짜는 문자형으로 저장)
