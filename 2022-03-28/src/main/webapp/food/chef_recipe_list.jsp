    ...
    <div class="row">
      <div class="text-center">
        <form method="post" action="chef_recipe_list.do">
          ...
          <a href="chef_recipe_list.do?chef=${chef }&ss=all" class="btn btn-sm btn-primary">전체</a>
        </form>
      </div>
    </div>
      ...
      <div class="text-center">
        <ul class="pagination">
          ...
          <c:forEach var="i" begin="${startPage }" end="${endPage }">
            ...
            <li ${style }><a href="chef_recipe_list.do?page=${i }&chef=${chef}">${i }</a></li>
          </c:forEach>
          <c:if test="${endPage<totalpage }">
            <li><a href="chef_recipe_list.do?page=${endPage+1 }&chef=${chef}">&gt;</a></li>
          </c:if>
		</ul>
      </div>
    </div>
