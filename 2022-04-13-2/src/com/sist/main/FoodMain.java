...
public class FoodMain {
                ...
                /*
                    ...
                    <div class="info">
                      <div class="wannago_wrap">
                        <button class="btn-type-icon favorite wannago_btn " data-restaurant_uuid="276164" data-action_id=""></button>
                          ...
                          <tr class="only-desktop"> 
                            <th>주소</th> 
                              <td>강원도 강릉시 옥가로 50<br/> 
                                ...
                                <span class="Restaurant__InfoAddress--Text">강원도 강릉시 옥천동 219-11</span> 
                              </td> 
                          </tr>
                          <tr class="only-desktop"> 
                            <th>전화번호</th> 
    ...
    public void foodLocationData() {
        DataDAO dao = DataDAO.newInstance();
        try {
            String[] gus = { "강서구", "양천구", "구로구", "마포구", "영등포구", "금천구", "은평구", "서대문구", "동작구", "관악구", "종로구", "중구", "용산구",
            ...
            for (String gu : gus) {
                ...
                for (int i = 1; i <= 10; i++) {
                    String url = "https://www.mangoplate.com/search/" + URLEncoder.encode(gu, "UTF-8") + "?keyword="
                            + URLEncoder.encode(gu, "UTF-8") + "&page=" + i;
                    Document doc = Jsoup.connect(url).get();
                    Elements link = doc.select("figure.restaurant-item a");
                    for (int j = 0; j < link.size(); j++) {
                        System.out.println(link.get(j).attr("href"));
                        Document doc2 = Jsoup.connect("https://www.mangoplate.com" + link.get(j).attr("href")).get();
                        /*
                            <div class="restaurant_title_wrap"> 
                            <span class="title"> 
                            <h1 class="restaurant_name">부성불고기찜닭</h1> 
