            ...
            <ul class="nospace clear">
              <c:forEach var="vo" items="${rList }" varStatus="s">
                <c:if test="${s.index%4==0 }">
                  <li class="one_quarter first"><a href="../seoul/location_detail.do?no=${vo.no }"><img src="${vo.poster }"  title="${vo.title }" style="width:300px;height:300px"></a></li>
                </c:if>
                <c:if test="${s.index%4!=0 }">
        ...
        <!-- class="current" -->
          <ul>
            ...
            <c:forEach var="i" begin="${startPage }" end="${endPage }">
              ...
              <li ${style }><a href="../seoul/location.do?page=${i }">${i }</a></li>
            </c:forEach>
