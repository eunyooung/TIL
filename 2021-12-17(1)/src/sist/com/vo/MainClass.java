...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        food.setScore(4.5);
        food.setAddress("경기도 용인시 수지구 이종무로 157 " + "지번 경기도 용인시 수지구 고기동 593-4");
        food.setTel("031-263-1107");
        food.setType("국수 / 면 요리");
        food.setPrice("만원 미만");
        food.setParking("무료주차 가능");
        food.setTime("11:00 - 21:00");
        food.setMenu("들기름막국수 " + "8,000원 " + "물막국수 " + "8,000원 " + "비빔막국수 " + "8,000원 " + "사리 " + "4,000원 " + "수육 (소) "
                + "13,000원");
        food.setGood(153);
        food.setSoso(15);
        food.setBad(10);
        ...
        System.out.println("======================");
        System.out
                .println("좋아요(" + food.getGood() + ") " + "괜찮다(" + food.getSoso() + ") " + "별로(" + food.getBad() + ")");
    }
}